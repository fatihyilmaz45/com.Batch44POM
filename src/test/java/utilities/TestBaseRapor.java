...
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        extentReports.setSystemInfo("Automation Engineer", "Mehmet");// ismi degistir
        extentHtmlReporter.config().setDocumentTitle("Son Test");//rapor basligi
        extentHtmlReporter.config().setReportName("TestNG Reports");//rapor ismi
    }
